...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="/resources/css/scrollbar.css">
    <script src="notice.js" type="/resources/text/javascript"></script>
    <script src="js/notices.js" type="/resources/text/javascript"></script>
    ...
    <div id="review">
      <table id="review_write">
        <tr id="title">
          ...
          <td class="col2"><input type="text" maxlength="30" name="subject" style="width: 450px;"></td>
        </tr>
        <tr id="date">
          <td class="col1">작성일자</td>
          <td class="col2" id="current_date"><input type="text" style="width: 200px;"></td>
        </tr>
        <tr id="content">
          <td class="col1">연결할 URL</td>
          <td class="col2"><textarea name="url" maxlength="310" cols="63" rows="5"></textarea></td>
        </tr>
        <tr class="file">
          <td class="col1">배너 이미지파일</td>
          <td class="col2">
            <input type="file" name='uploadFile' style="height: 20px; width: 200px; font-family: 'RIDIBatang';">
          </td>
        </tr>
        <tr class="file">
          <td class="col1">팝업 이미지파일</td>
          <td class="col2">
            <input type="file" name="popimg" style="height: 20px; width: 200px; font-family: 'RIDIBatang';">
          </td>
        </tr>
      </table>
