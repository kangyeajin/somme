...
<body>
  ...
  <!-- 리뷰작성 폼 -->
  <form name="frm" method="post" action="/review/review_write">
    ...
    <div id="review">
      ...
      <table id="review_write">
        <tr id="title">
          <td class="col1">제목</td>
          <td class="col2"><input name="subject" type="text" style="width: 450px;" maxlength="30" oninput="numberMaxLength(this)"></td>
        </tr>
        <tr id="pwd">
          <td class="col1">비밀번호</td>
          <td class="col2"><input type="password" name="pwd" maxlength="15" oninput="numberMaxLength(this)" style="width: 200px;"></td>
        </tr>
        <tr id="date">
          <td class="col1">작성일자</td>
          <td class="col2" id="current_date"><input type="text" name="indate" style="width: 200px;"></td>
        </tr>
        <tr id="content">
          <td colspan="2" class="col2"><textarea name="content" maxlength="310" oninput="numberMaxLength(this)" cols="100" rows="30"></textarea></td>
        </tr>
        <tr class="file">
          <td class="col1">첨부파일</td>
          <td class="col2">
            <input type="file" name='uploadFile' style="height: 20px; width: 200px; font-family:'RIDIBatang';" multiple>
          </td>
        </tr>
      </table>
