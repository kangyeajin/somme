...
<body id="body">
	...
	<%@ include file="../include/header.jsp"%>
		...
		<div id="main">
			<form name="frm" id="reviewBestForm" action="/review/review_best">
			<div id="title">
				<h2>리뷰</h2>
			</div>
				<div id="box1">
					<div id="button">
						<button type="submit" id="product">제품 구경하기</button>
						<button type="submit">목록</button>
					</div>
					<table table frame="above">
						<tr>
							<td width="200px" bgcolor="#f4f4f4">제목</td>
							<td colspan="3" width="800px">${reviewVO.subject}</td>
						</tr>
					</table>
...
$(document).ready(function(){
	var rbForm = $('#reviewBestForm');
	$('#product').on('click', function(e){
		e.preventDefault();
		rbForm.append("<input type='hidden' name='prodno' value='"+${reviewVO.prodno}+"'>");
		rbForm.attr("action","/product/detail"); //action 수정
		rbForm.submit();
	});
});
</script>
